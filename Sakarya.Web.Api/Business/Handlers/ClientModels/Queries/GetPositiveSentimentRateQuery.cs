...
namespace Business.Handlers.ClientModels.Queries
{
    ...
    {
        public class
            GetPositiveSentimentRateQueryHandler : IRequestHandler<GetPositiveSentimentRateQuery, IDataResult<int>>
        {
            private readonly IClientModelRepository _clientModelRepository;
            private readonly IMediator _mediator;

            public GetPositiveSentimentRateQueryHandler(IClientModelRepository clientModelRepository,
                IMediator mediator)
            {
            ...
            public async Task<IDataResult<int>> Handle(GetPositiveSentimentRateQuery request,
